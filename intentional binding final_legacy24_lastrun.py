...
expName = 'intentional binding final'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\aashn\\OneDrive\\Documents\\intentional binding final_legacy24_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='report the delay between the keypress and the beep sound (0 - 999); click submit after entering the value',
        font='Open Sans',
